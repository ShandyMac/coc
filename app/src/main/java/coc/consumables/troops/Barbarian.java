 ...
 */
public class Barbarian extends BaseConsumableUnit {
    ...
    public Barbarian(int level)
    {
        ...
        _levelCosts.add(new LevelCost(4,100));
        _levelCosts.add(new LevelCost(5,150));
        _levelCosts.add(new LevelCost(6,200));
        _levelCosts.add(new LevelCost(7, 250));
