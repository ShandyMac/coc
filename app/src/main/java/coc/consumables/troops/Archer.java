...
public class Archer extends BaseConsumableUnit {
    ...
    public Archer(int level)
    {
        ...
        _levelCosts.add(new LevelCost(1,50));
        _levelCosts.add(new LevelCost(2,80));
        _levelCosts.add(new LevelCost(3,120));
        _levelCosts.add(new LevelCost(4,200));
        _levelCosts.add(new LevelCost(5,300));
        _levelCosts.add(new LevelCost(6,400));
        _levelCosts.add(new LevelCost(7,500));
