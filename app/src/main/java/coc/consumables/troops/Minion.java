 ...
 */
public class Minion extends BaseConsumableUnit {
    ...
    public Minion(int level)
    {
        ...
        _levelCosts.add(new LevelCost(1,6));
        _levelCosts.add(new LevelCost(2,7));
        _levelCosts.add(new LevelCost(3,8));
        _levelCosts.add(new LevelCost(4,9));
        _levelCosts.add(new LevelCost(5,10));
        _levelCosts.add(new LevelCost(6,11));
