 ...
 */
public class Golem extends BaseConsumableUnit {
    ...
    public Golem(int level)
    {
        ...
        _levelCosts.add(new LevelCost(1,450));
        _levelCosts.add(new LevelCost(2,525));
        _levelCosts.add(new LevelCost(3,600));
        _levelCosts.add(new LevelCost(4,675));
        _levelCosts.add(new LevelCost(4,750));
